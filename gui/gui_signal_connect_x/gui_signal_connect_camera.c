...
void 				gui_signal_connect_camera(t_gui *gui)
{
	...
	RT_GUI_CONNECT(gui->builder, gui_signal_camera_screen_save);
	RT_GUI_CONNECT(gui->builder, gui_signal_camera_screen_success_close);
	RT_GUI_CONNECT(gui->builder, gui_signal_camera_screen_fail_close);
