...
void				gui_signal_connect_settings(t_gui *gui)
{
	...
	RT_GUI_CONNECT(gui, gui_signal_settings_srgb);
	RT_GUI_CONNECT(gui, gui_signal_settings_light_basic);
	RT_GUI_CONNECT(gui, gui_signal_settings_light_area);
	RT_GUI_CONNECT(gui, gui_signal_settings_pt_russian);
