						...
						(t_gui_scene_edit *edit, GtkBuilder *builder)
{
	...
	ft_strcpy(init.offscreen, "object_edit_sphere_offscreen");
	ft_strcpy(init.name, "object_edit_sphere_name");
	...
	gui_object_x_set((t_gui_object_x *) &edit->sphere, edit->overlay);
}
