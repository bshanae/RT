...
std::vector<Shape *> complexScene = {
		...
		new Sphere(Vector(35,65.1,120), 1.5, Vector(), Vector(4,4,4) * 100), // Light
		new Sphere(Vector(65,65.1,120), 1.5, Vector(), Vector(4,4,4) * 100), // Light
};
//
...
int main(int argc, const char *argv[]) {
	...
	L = L_new;
	Ray camera = Ray(Vector(50, 52, 335.6) + cam_shift, dir_norm);
