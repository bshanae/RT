...
int					main()
{
	...
	scene_add_shape(renderer->scene, shape_sphere((t_vector3){-10., 25., 45.}, 2., MATERIAL_LIGHT));
	scene_add_shape(renderer->scene, shape_sphere((t_vector3){10., 25., 25.}, 2., MATERIAL_LIGHT));

//	scene_add_shape(renderer->scene, shape_sphere((t_vector3){-15., 0., 20.}, 7., MATERIAL_MIRROR));
