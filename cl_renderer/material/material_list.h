...
# define MATERIAL_GLASS			RT_M1{COLOR_BLACK, COLOR_BLACK, .0, 0., .5}
...
# define MATERIAL_PINK 	        RT_M1{COLOR_PINK, COLOR_BLACK, .94, 0.22, 0.22}
# define MATERIAL_PINK_1		RT_M1{COLOR_PINK_1, COLOR_BLACK, .0, 0., 0.}
# define MATERIAL_MONE_BLUE		RT_M1{COLOR_M_BLUE_1, COLOR_BLACK, .0, 0., 0.}
# define MATERIAL_MONE_YELLOW	RT_M1{COLOR_YELLOW,COLOR_BLACK, .0, 0., 0.}
# define MATERIAL_MONE_BLUE_1	RT_M1{COLOR_M_BLUE, COLOR_BLACK, .0, 0., 0.}
