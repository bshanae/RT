...
# define MATERIAL_PINK 	        RT_M1{COLOR_PINK, COLOR_BLACK, .0, 0., 0.}
# define MATERIAL_PINK_1		RT_M1{COLOR_PINK_1, COLOR_BLACK, .0, 0., 0.}
# define MATERIAL_MONE_BLUE		RT_M1{COLOR_MONE_BLUE, COLOR_BLACK, .0, 0., 0.}
# define MATERIAL_MONE_YELLOW	RT_M1{COLOR_MONE_YELLOW, COLOR_BLACK, .0, 0., 0.}
# define MATERIAL_MONE_BLUE_1	RT_M1{COLOR_MONE_BLUE_1, COLOR_BLACK, .0, 0., 0.}
